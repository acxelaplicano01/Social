                                                ...
                                                <div class="p-3 md:p-4 space-y-6 overflow-y-auto max-h-96">
                                                    ...
                                                    <div class="bg-white">
                                                        <article>
                                                            ...
                                                            <p class="mb-2 text-gray-500 dark:text-gray-400">This is my
                                                                third Invicta Pro Diver.
                                                                They are just fantastic value for money. This one
                                                                arrived yesterday and the first
                                                                thing I did was set the time, popped on an identical
                                                            ...
                                                            <div>
                                                                ...
                                                                <video class="h-auto w-full rounded-xl" autoplay
                                                                    controls>
                                                                        ...
                                                                        <div class="me-2">
                                                                            ...
                                                                            <span
                                                                                ...
                                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                                    aria-hidden="true"
                                                                                    class="self-center" width="3"
                                                                                    height="4" viewBox="0 0 3 4"
                                                                                    fill="none">
